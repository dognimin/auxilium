        ...
        if($user['mot_de_passe_statut'] == 0) {
            ...
            <div class="col">
                <div class="row">
                    ...
                    <div class="col"><a href="<?= URL.'parametres/referentiels/ngambci';?>" class="btn btn-danger btn-sm btn-block" title="Nomenclature Générale les Actes de Médecine et de Biologie de Côte d'Ivoire">NGAMBCI</a></div>
                </div><br />
                <div class="row">
