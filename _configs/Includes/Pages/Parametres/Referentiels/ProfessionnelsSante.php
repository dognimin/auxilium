...
if(!isset($_SESSION['auxilium_user_id'])){
    ...
    if(empty($user['user_id'])) {
        ...
        if($user['mot_de_passe_statut'] == 0) {
            ...
            $specialites = $PROFESSIONNELSANTE->lister_specialites_medicales();
            $villes = $PROFESSIONNELSANTE->lister_villes();
            ?>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Professionnels de santé</li>
                </ol>
            </nav>
            <div class="col">
                <?php include "../../Forms/form_recherche_professionnels_sante.php";?>
            </div>
            <?php
