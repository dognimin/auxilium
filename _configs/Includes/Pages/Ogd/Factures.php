                        ...
                        if(empty($user['code_ogd'])) {
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-sm-3">
                                        <a href="<?= URL.'ogd/factures-verification?code-ogd='.$ogd['code'];?>" class="btn btn-outline-primary btn-block btn-sm"><i class="fa fa-check-square"></i><br /> VERIFICATION</a>
                                    </div>
                                    <div class="col-sm-3">
                                        <a href="<?= URL.'ogd/factures-liquidation?code-ogd='.$ogd['code'];?>" class="btn btn-outline-primary btn-block btn-sm"><i class="fa fa-flask"></i><br /> LIQUIDATION</a>
                                    </div>
                                </div>
                            </div>
                            <?php
