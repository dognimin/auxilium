        ...
        if($user['mot_de_passe_statut'] == 0) {
            ...
            if(!$user['code_ogd']) {
                ...
                if(!$ogd) {
                    ...
                    $fichiers = $FACTURES->lister_decomptes($user['code_ogd'],'DECA','N');
                    ?>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-check-square"></i> Vérification</li>
                        </ol>
                    </nav>
                    <div class="col">
                        <?php
                        include "../Forms/form_recherche_factures_a_verifier.php";
                        ?>
                    </div>
                    <?php
...
?>
<script>
    display_ogd_factures_a_verifier_ou_liquider('DECA',null,null,null,'N');
</script>
