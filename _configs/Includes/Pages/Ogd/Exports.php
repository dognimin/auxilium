                        ...
                        if(empty($user['code_ogd'])) {
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-sm-3">
                                        <a href="<?= URL.'ogd/import-deca?code-ogd='.$ogd['code'];?>" class="btn btn-outline-primary btn-block btn-sm"><i class="fa fa-upload"></i><br /> Imports</a>
                                    </div>
                                    <div class="col-sm-3">
                                        <a href="<?= URL.'ogd/import-decret?code-ogd='.$ogd['code'];?>" class="btn btn-outline-primary btn-block btn-sm"><i class="fa fa-download"></i><br /> Exports</a>
                                    </div>
                                </div>
                            </div>
                            <?php
