                ...
                if(!$ogd) {
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?= URL.'ogd/chargements?code-ogd='.$ogd['code'];?>"><i class="fa fa-exchange-alt"></i> Chargements</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-download"></i> Exports</li>
                        </ol>
                    </nav>
                    <div class="col">
                        <?php
                        if($user['code_ogd']) {
                            include "../Forms/form_exports.php";
                            $fichiers = $LOGS->lister_fichiers($user['code_ogd'],NULL,'EXP',NULL,NULL);
                                        ...
                                        <table class="table table-bordered table-hover table-sm dataTable">
                                            ...
                                            foreach ($fichiers as $fichier) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= URL.'EXPORTS/CHARGEMENTS/'.$fichier['norme'].'/'.$user['code_ogd'].'/'.$fichier['fichier_nom'];?>" target="_blank" class="badge badge-success" download="<?= $fichier['fichier_nom'];?>"><i class="fa fa-download"></i></a></td>
                                                </tr>
                                                <?php
                                                $ligne++;
                                            }
