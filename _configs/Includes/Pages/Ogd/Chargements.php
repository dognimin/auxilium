                ...
                if($ogd) {
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-upload"></i> Chargements</li>
                        </ol>
                    </nav>
                    <div class="col">
                        <?php
                        ...
                        if(empty($user['code_ogd'])) {
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-sm-3">
                                        <a href="<?= URL.'ogd/imports?code-ogd='.$ogd['code'];?>" class="btn btn-outline-primary btn-block btn-sm"><i class="fa fa-upload"></i><br /> Imports</a>
                                    </div>
                                    <div class="col-sm-3">
                                        <a href="<?= URL.'ogd/exports?code-ogd='.$ogd['code'];?>" class="btn btn-outline-primary btn-block btn-sm"><i class="fa fa-download"></i><br /> Exports</a>
                                    </div>
                                </div>
                            </div>
                            <?php
